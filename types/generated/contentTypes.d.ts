...
export interface ApiColumnColumn extends Schema.CollectionType {
  ...
  attributes: {
    ...
    custom: Attribute.Boolean;
    board: Attribute.Relation<
      'api::column.column',
      'manyToOne',
      'api::board.board'
    >;
    boardId: Attribute.String & Attribute.Required;
...
export interface ApiTaskTask extends Schema.CollectionType {
  ...
  attributes: {
    ...
    estimate_hour: Attribute.Integer;
    estimate_minute: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
